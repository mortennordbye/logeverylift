...
- **Touchpoints:** `src/components/features/WorkoutSetsList.tsx` (300-360), `src/components/features/SetEditView.tsx` (260-305), `src/lib/utils/progression.ts` (`metTargetReps`, `countConsecutiveFails`), `docs/specs/smart-incrementation.md` (SI-9, SI-17, SI-19).
