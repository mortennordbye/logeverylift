...
> **Status:** built. All seven phases have shipped and nothing is pushed. What remains is not construction — it is the e2e suite, the smoke pass and five release notes, all listed in §0's carry-forward, and every one of them needs a running app or a human. See §0 "Build state".
